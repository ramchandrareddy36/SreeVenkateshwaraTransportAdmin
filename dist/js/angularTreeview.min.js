                ...
                var template =
					'<ul>' +
						'<li data-ng-repeat="node in ' + treeModel + '">' +
							...
							'<span data-ng-class="{selectedClass:node.ID==highlightedNode}" data-ng-click="' + treeId + '.selectNodeLabel(node)"><span>{{node.' + nodeLabel + '}}</span></span>' +
                ...
                if (treeId && treeModel) {
                    ...
                    if (attrs.angularTreeview) {
                        ...
                        scope[treeId].selectNodeLabel = scope[treeId].selectNodeLabel || function (selectedNode) {
                            scope[treeId].currentNode = scope.a;
                            ...
                            scope.a = scope[treeId].currentNode;

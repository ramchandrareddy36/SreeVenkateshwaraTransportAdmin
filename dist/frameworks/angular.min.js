...
(function (C) {
    ...
    var Sd = function (a) {
        ...
        emailid = /^(\w+([\.-]?\w+){5,30})*@\w+([\.-]?\w+)*(\.\w{2,3})+$/,
        lontde = /^[0-9]{2,4}[.]{1}[0-9]{4,6}$/,
        ltitde = /^[0-9]{2,4}[.]{1}[0-9]{4,6}$/,
        ifse = /^[a-zA-z]{4}[0-9]{7}$/,
        Ld = U();
    ...
    var Xd = {
        ...
        phonenumber: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "phonenumber";
            c.$validators.phonenumber = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || Ph.test(d)
            }
        },
        adharnumber: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "adharnumber";
            c.$validators.adharnumber = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || an.test(d)
            }
        },
        pannumber: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "pannumber";
            c.$validators.pannumber = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || pan.test(d)
            }
        },
        gstnumber: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "gstnumber";
            c.$validators.gstnumber = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || gst.test(d)
            }
        },
        emailid: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "emailid";
            c.$validators.emailid = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || emilid.test(d)
            }
        },
        longitude: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "longitude";
            c.$validators.longitude = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || lontde.test(d)
            }
        },
        latitude: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "latitude";
            c.$validators.latitude = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || ltitde.test(d)
            }
        },
        ifsccode: function (a, b, d, c, e, f) {
            lb(a, b, d, c, e, f);
            pc(c);
            c.$$parserName = "ifsccode";
            c.$validators.ifsccode = function (a, b) {
                var d = a || b;
                return c.$isEmpty(d) || ifse.test(d)
            }
        },

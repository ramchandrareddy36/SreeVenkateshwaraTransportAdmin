...
var app = angular.module('autocomplet', []);

app.directive('autocomplet', function () {
    var index = -1;
    ...
    return {
        ...
        template: '\
        <div class="autocomplet {{ attrs.class }}" id="{{ attrs.id }}">\
          <input\
            type="text"\
...
app.directive('suggestion', function () {
    return {
        restrict: 'A',
        require: '^autocomplet', // ^look for controller on parents element

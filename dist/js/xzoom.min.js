	...
	function a(aw, aF) {
		...
		this.openzoom = function (u) {
			...
			R.xon("load", function () {
				...
				X = h / Z;
				V = ag / ai;
				var aL, aM = ["padding-", "border-"];
				n = P = 0;
				for (var v = 0; v < aM.length; v++) {
					aL = parseFloat(l.css(aM[v] + "top-width"));
					n += aL !== aL ? 0 : aL;
					aL = parseFloat(l.css(aM[v] + "bottom-width"));
					n += aL !== aL ? 0 : aL;
					aL = parseFloat(l.css(aM[v] + "left-width"));
					P += aL !== aL ? 0 : aL;
					aL = parseFloat(l.css(aM[v] + "right-width"));
					P += aL !== aL ? 0 : aL
				}
				n /= 2;
				P /= 2;
